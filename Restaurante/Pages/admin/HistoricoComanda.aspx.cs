...
public partial class Pages_admin_HistoricoComanda : System.Web.UI.Page
{
    ...
    void atualizarPagina()
    {
        ...
        DataSet ds = AdminDB.selectHistoricoComanda(Convert.ToInt32(txtHistoricoAno.Text));

        rptComanda.DataSource = ds;
        rptComanda.DataBind();

        DataSet ds2 = AdminDB.selectHistoricoComandaCancelada(Convert.ToInt32(txtHistoricoAno.Text));

        rptComandaCancelada.DataSource = ds2;
        rptComandaCancelada.DataBind();
    }
