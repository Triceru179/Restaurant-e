...
public partial class Pages_admin_HistoricoPagamento : System.Web.UI.Page
{
    ...
    void atualizarPagina()
    {
        ...
        DataSet ds = AdminDB.selectHistoricoPagamento(Convert.ToInt32(txtHistoricoAno.Text));

        /* Preenche a tabela com todos os produtos do banco */
        rptPagamento.DataSource = ds;
        rptPagamento.DataBind();
    }
