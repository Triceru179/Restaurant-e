<%@ Page Title="Gerente" Language="C#" MasterPageFile="~/Pages/Page.master" AutoEventWireup="true" CodeFile="Reclamacao.aspx.cs" Inherits="Pages_gerente_Reclamacao" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Menu" Runat="Server">
    <nav class="navbar nav-menu bg-secondary fixed-top p-0">
        <div class="container-fluid">
            ...
            <span class="text-light navbar-brand"> Registrar reclamação </span>
        </div>
    </nav>
    <div class="pb-4"></div>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" Runat="Server">
    ...
    <div class="row mt-3">
        ...
        <div runat="server" class="col-12 text-center my-5" id="divNenhumaReclamacao">
            <div class="h3 my-5"> Nenhuma reclamação registrada </div>
        </div>
            ...
            <ItemTemplate>
                <div class="col-12 col-md-4 mb-3">
                    <div class="card bg-primary px-1 mx-0">
                        <div class="card-body">
                            <label> Reclamação&nbsp;</label><asp:Label runat="server" ID="hidRecIdent" Text='<%# Container.ItemIndex + 1 %>'/>
                            <hr />
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <label>Registrar reclamação</label>
                ...
                <div class="modal-body">
                    ...
                    <asp:TextBox runat="server" type="text" MaxLength="254" autocomplete="off" ID="txtCategoriaAdicionar" CssClass="form-control"></asp:TextBox>
                    <label>Insira a descrição</label>
                    <asp:TextBox runat="server" type="text" rows="5" TextMode="multiline" MaxLength="254" autocomplete="off" ID="txtDescricaoAdicionar" CssClass="form-control"></asp:TextBox>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal"> Fechar </button>
                    <asp:Button runat="server" id="btnAdicionar" CssClass="btn btn-success" Text="Registrar" type="submit" OnClick="btnAdicionar_Click"/>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="mdlEditar" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <label>Editar reclamação</label>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <label> Reclamação&nbsp;</label><asp:Label runat="server" ID="hidEditarRecIdent" Text=""/><br />
                    <asp:HiddenField runat="server" ID="hidIdEditar" Value=""/>

                    <label>Insira a categoria</label>
                    <asp:TextBox runat="server" type="text" MaxLength="254" autocomplete="off" ID="txtCategoriaEditar" CssClass="form-control"></asp:TextBox>
                    <label>Insira a descrição</label>
                    <asp:TextBox runat="server" type="text" MaxLength="254" autocomplete="off" ID="txtDescricaoEditar" CssClass="form-control"></asp:TextBox>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal"> Fechar </button>
                    <asp:Button runat="server" id="btnEditar" CssClass="btn btn-success" Text="Editar" type="submit" OnClick="btnEditar_Click"/>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="mdlRemover" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <asp:HiddenField runat="server" id="hidIdExcluir" Value=""/>
                    <label>Remover</label> a reclamação 
                    <asp:Label runat="server" type="text" CssClass="text-warning" ID="hidExcluirRecIdent"></asp:Label>?
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal"> Fechar </button>
                    <asp:Button runat="server" id="btnExcluir" CssClass="btn btn-danger" Text="Remover" type="submit" OnClick="btnExcluir_Click"/>
                </div>
            </div>
        </div>
    </div>
